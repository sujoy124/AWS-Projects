...
- Go to https://console.developers.google.com/cloud-resource-manager Select PetIDF and click DELETE
...
-Locate and expand Delete identity pool. Click Delete Identity Pool. Click Delete Pool

**Delete the IAM Roles**
- Move to the IAM Console
- Select Roles. Select both Cognito_PetIDF* roles
- Click Delete Role. Click Yes Delete
